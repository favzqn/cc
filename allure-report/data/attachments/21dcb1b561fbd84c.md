...
```
Error: locator.waitFor: Error: strict mode violation: locator('.oxd-select-option').filter({ hasText: 'Australian' }) resolved to 4 elements:
    ...
    2) <div role="option" data-v-d130bb63="" data-v-13cf171c="" class="oxd-select-option">…</div> aka getByRole('option', { name: 'Australian303_1785990765796' })
    ...
